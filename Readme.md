# Ridge 🦅
[![build](https://github.com/debanjum/ridge/actions/workflows/build.yml/badge.svg)](https://github.com/debanjum/ridge/actions/workflows/build.yml)
[![test](https://github.com/debanjum/ridge/actions/workflows/test.yml/badge.svg)](https://github.com/debanjum/ridge/actions/workflows/test.yml)
[![publish](https://github.com/debanjum/ridge/actions/workflows/publish.yml/badge.svg)](https://github.com/debanjum/ridge/actions/workflows/publish.yml)
...
- [Features](#Features)
- [Demos](#Demos)
  - [Ridge in Obsidian](#ridge-in-obsidian)
  - [Ridge in Emacs, Browser](#ridge-in-emacs-browser)
...
- Let Ridge backend index the markdown files in the current Vault
...
- **Ridge via API**
  - See the Ridge FastAPI [Swagger Docs](http://localhost:8000/docs), [ReDocs](http://localhost:8000/redocs)
...
- Symptom: `pip install ridge-assistant` fails while building the `tokenizers` dependency. Complains about Rust.
...
# Maps to the latest tagged version of ridge on master branch
pip install --upgrade ridge-assistant
...
- **Optional**: Edit application configuration in [ridge_docker.yml](./config/ridge_docker.yml)
