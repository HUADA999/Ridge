...
- Check the [Ridge Emacs docs](/docs/clients/emacs?id=setup) to setup Ridge with Emacs<br />
  It's simpler as it can skip the server *install*, *run* and *configure* step below.
- Check the [Ridge Obsidian docs](/docs/clients/obsidian?id=_2-setup-plugin) to setup Ridge with Obsidian<br />
...
- **Ridge Obsidian**:<br />
[Install](/docs/clients/obsidian?id=_2-setup-plugin) the Ridge Obsidian plugin

- **Ridge Emacs**:<br />
[Install](/docs/clients/emacs?id=setup) ridge.el
...
```mdx-code-block
  <Tabs groupId="environment">
    ...
    - See [ridge.el package setup](/docs/clients/emacs?id=setup) for details
    </TabItem>
    <TabItem value="obsidian" label="Obsidian">
      - Upgrade via the Community plugins tab on the settings pane in the Obsidian app
      - See the [ridge plugin setup](/docs/clients/obsidian?id=_2-setup-plugin) for details
    </TabItem>
  </Tabs>
```
