...
Your setup is complete once you see `🌖 Ridge is ready to use` in the server logs on your terminal.
  </TabItem>
...
3. Your setup is complete once you see `🌖 Ridge is ready to use` in the server logs on your terminal!
