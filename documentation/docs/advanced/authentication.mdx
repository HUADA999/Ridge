...
For either of these methods, you'll need to use the prod version of the Ridge package. You can install it as below:

<Tabs groupId="server" queryString>
  <TabItem value="docker" label="Docker">
  Update your `docker-compose.yml` to use the prod image
      ```bash
      image: ghcr.io/ridge-ai/ridge-cloud:latest
      ```
  </TabItem>
