...
By default, you admin panel is available at `http://localhost:42110/server/admin/`. You can access the admin panel by logging in with your admin credentials (this would be your `RIDGE_ADMIN_EMAIL` and `RIDGE_ADMIN_PASSWORD`). The admin panel allows you to configure various settings for your Ridge server.
