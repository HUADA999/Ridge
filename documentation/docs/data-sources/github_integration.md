...
2. Navigate to [https://app.ridge.dev/settings#github](https://app.ridge.dev/settings#github) to configure your Github settings. Enter in your PAT, along with details for each repository you want to index.
