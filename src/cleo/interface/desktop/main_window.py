...
from ridge.interface.desktop.file_browser import FileBrowser
from ridge.interface.desktop.labelled_text_field import LabelledTextField
from ridge.utils import constants, state, yaml as yaml_utils
from ridge.utils.cli import cli
from ridge.utils.config import SearchType, ProcessorType
from ridge.utils.helpers import merge_dicts, resolve_absolute_path
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    3. Save the configuration to ridge.yml
    """
    ...
    def configure_app(self):
        "Save the new settings to ridge.yml. Reload app with updated settings"
