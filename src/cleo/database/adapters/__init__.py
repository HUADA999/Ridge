...
class ConversationAdapters:
    ...
    @staticmethod
    def get_user_paint_model_config(user: RidgeUser):
    ...
    @staticmethod
    async def aget_user_paint_model(user: RidgeUser):
    ...
    @staticmethod
    async def aset_user_paint_model(user: RidgeUser, text_to_image_model_config_id: int):
