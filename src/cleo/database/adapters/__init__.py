...
class ConversationAdapters:
    @staticmethod
    def get_conversation_by_user(user: RidgeUser, client_application: ClientApplication = None):
    ...
    @staticmethod
    async def aget_conversation_by_user(user: RidgeUser, client_application: ClientApplication = None):
        conversation = Conversation.objects.filter(user=user, client=client_application)
    ...
    @staticmethod
    def save_conversation(user: RidgeUser, conversation_log: dict, client_application: ClientApplication = None):
        conversation = Conversation.objects.filter(user=user, client=client_application)
        if conversation.exists():
