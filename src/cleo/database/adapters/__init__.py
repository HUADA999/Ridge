...
class ConversationAdapters:
    ...
    def get_conversation_by_user(
        user: RidgeUser, client_application: ClientApplication = None, conversation_id: int = None
    ...
    @staticmethod
    def get_conversation_by_unique_id(user: RidgeUser, unique_id: str):
    ...
    async def aset_conversation_title(
        user: RidgeUser, client_application: ClientApplication, conversation_id: int, title: str
    ):
    ...
    async def aget_conversation_by_user(
        user: RidgeUser, client_application: ClientApplication = None, conversation_id: int = None, title: str = None
    ) -> Optional[Conversation]:
    ...
    @staticmethod
    def add_files_to_filter(user: RidgeUser, conversation_id: int, files: List[str]):
    ...
    @staticmethod
    def remove_files_from_filter(user: RidgeUser, conversation_id: int, files: List[str]):
        conversation = ConversationAdapters.get_conversation_by_user(user, conversation_id=conversation_id)
        for filename in files:
...
class EntryAdapters:
    ...
    @staticmethod
    def apply_filters(user: RidgeUser, query: str, file_type_filter: str = None):
        q_filter_terms = Q()
