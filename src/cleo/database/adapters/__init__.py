...
class EntryAdapters:
    ...
    @staticmethod
    def delete_all_entries_by_type(user: RidgeUser, file_type: str = None):
    ...
    @staticmethod
    def delete_all_entries(user: RidgeUser, file_source: str = None):
    ...
    @staticmethod
    async def adelete_all_entries(user: RidgeUser, file_source: str = None):
        if file_source is None:
