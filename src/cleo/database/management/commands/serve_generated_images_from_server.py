...
from ridge.database.models import Conversation
from ridge.utils.helpers import ImageIntentType, is_none_or_empty


class Command(BaseCommand):
    help = "Serve Ridge generated images from a different URL."
