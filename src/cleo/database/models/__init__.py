...
from ridge.utils.helpers import ConversationCommand
...
class RidgeApiUser(models.Model):
    """User issued API tokens to authenticate Ridge clients"""
...
class Subscription(BaseModel):
    ...
    user = models.OneToOneField(RidgeUser, on_delete=models.CASCADE, related_name="subscription")
...
class Agent(BaseModel):
    ...
    creator = models.ForeignKey(
        RidgeUser, on_delete=models.CASCADE, default=None, null=True, blank=True
...
class PublicConversation(BaseModel):
    source_owner = models.ForeignKey(RidgeUser, on_delete=models.CASCADE)
    conversation_log = models.JSONField(default=dict)
    slug = models.CharField(max_length=200, default=None, null=True, blank=True)
    title = models.CharField(max_length=200, default=None, null=True, blank=True)
    agent = models.ForeignKey(Agent, on_delete=models.SET_NULL, default=None, null=True, blank=True)
...
class ReflectiveQuestion(BaseModel):
    ...
    user = models.ForeignKey(RidgeUser, on_delete=models.CASCADE, default=None, null=True, blank=True)
...
class DataStore(BaseModel):
    ...
    owner = models.ForeignKey(RidgeUser, on_delete=models.CASCADE, default=None, null=True, blank=True)
