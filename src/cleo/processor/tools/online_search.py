...
from ridge.database.models import Agent, RidgeUser, ServerChatSettings
...
from ridge.utils.helpers import is_internet_connected, is_none_or_empty, timer
...
async def read_webpage_and_extract_content(
    subqueries: set[str], url: str, content: str = None, user: RidgeUser = None, agent: Agent = None
