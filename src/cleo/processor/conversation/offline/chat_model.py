...
from ridge.utils.helpers import ConversationCommand, in_debug_mode, is_none_or_empty
...
def send_message_to_model_offline(
    ...
    seed = int(os.getenv("RIDGE_LLM_SEED")) if os.getenv("RIDGE_LLM_SEED") else None
