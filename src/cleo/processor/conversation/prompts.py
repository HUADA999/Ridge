...
pick_relevant_output_mode = PromptTemplate.from_template(
    """
You are Ridge, an excellent analyst for selecting the correct way to respond to a user's query.
{personality_context}
...
python_code_generation_prompt = PromptTemplate.from_template(
    """
You are Ridge, an advanced python programmer. You are tasked with constructing **up to three** python programs to best answer the user query.
...
Executed User Query: Check if version 2.0.0 of the Ridge python package is released
