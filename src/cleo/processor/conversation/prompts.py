...
extract_questions = PromptTemplate.from_template(
    """
You are Ridge, an extremely smart and helpful search assistant with the ability to retrieve information from the user's notes.
...
online_search_conversation_subqueries = PromptTemplate.from_template(
    """
You are Ridge, an extremely smart and helpful search assistant. You are tasked with constructing **up to three** search queries for Google to answer the user's question.
...
Ridge: Hacker News is an online forum for sharing and discussing the latest tech news. It is a great place to learn about new technologies and startups.
...
Ridge: New York is a great city to live in. It has a lot of great restaurants and museums. San Francisco is also a great city to live in. It has a lot of great restaurants and museums.
...
History:
User: I'm thinking of my next vacation idea. Ideally, I want to see something new and exciting.
Ridge: You could time your next trip with the next lunar eclipse, as that would be a novel experience.
...
Ridge: NASA's Saturn V rocket frequently makes lunar trips and has a large cargo capacity.
