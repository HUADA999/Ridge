...
from ridge.processor.conversation.utils import message_to_prompt, generate_chatml_messages_with_context
...
def extract_questions(text, model="text-davinci-003", conversation_log={}, api_key=None, temperature=0, max_tokens=100):
    ...
    prompt = f"""
You are Ridge, an extremely smart and helpful search assistant with the ability to retrieve information from the users notes.
...
def converse(text, user_query, conversation_log={}, api_key=None, temperature=0.2):
    ...
    personality_primer = "You are Ridge, a friendly, smart and helpful personal assistant."
