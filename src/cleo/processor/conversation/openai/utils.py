...
from ridge.processor.conversation.utils import JsonSupport, commit_conversation_trace
...
def completion_with_backoff(
    ...
    if os.getenv("RIDGE_LLM_SEED"):
        model_kwargs["seed"] = int(os.getenv("RIDGE_LLM_SEED"))
