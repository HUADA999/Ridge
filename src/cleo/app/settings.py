...
from ridge.utils.helpers import is_env_var_true

# Build paths inside the project like this: BASE_DIR / 'subdir'.
BASE_DIR = Path(__file__).resolve().parent.parent

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = os.getenv("RIDGE_DJANGO_SECRET_KEY", "!secret")

# Set RIDGE_DOMAIN to custom domain for production deployments.
RIDGE_DOMAIN = os.getenv("RIDGE_DOMAIN") or "ridge.dev"

# Set RIDGE_ALLOWED_DOMAIN to the i.p or domain of the Ridge service on the internal network.
...
# All Subdomains of RIDGE_DOMAIN are trusted for CSRF
...
INSTALLED_APPS = [
    ...
    "ridge.database.apps.DatabaseConfig",
    "unfold",
...
DB_NAME = os.getenv("POSTGRES_DB", "ridge")
...
# User Settings
AUTH_USER_MODEL = "database.RidgeUser"
...
UNFOLD = {
    "SITE_TITLE": "Ridge Admin Panel",
    "SITE_HEADER": "Ridge Admin Panel",
    "SITE_URL": "/",
    "SITE_ICON": {
        "light": lambda request: static("assets/icons/ridge_lantern_128x128.png"),
        "dark": lambda request: static("assets/icons/ridge_lantern_128x128_dark.png"),
    },
    "SITE_FAVICONS": [
        {
            "rel": "icon",
            "sizes": "32x32",
            "type": "image/svg+xml",
            "href": lambda request: static("assets/icons/ridge_lantern.svg"),
        },
    ],
}
