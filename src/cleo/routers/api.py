...
from ridge.processor.conversation.gpt import converse, extract_questions
from ridge.processor.conversation.utils import message_to_log, reciprocal_conversation_to_chatml
...
def chat_init(
    ...
    if (
        ...
        raise HTTPException(
            status_code=500, detail="Set your OpenAI API key via Ridge settings and restart it to use Ridge Chat."
        )
...
async def chat(
    ...
    def _save_to_conversation_log(
        ...
        state.processor_config.conversation.meta_log["chat"] = message_to_log(
            ...
            ridge_message_metadata={"context": compiled_references, "intent": {"inferred-queries": inferred_queries}},
