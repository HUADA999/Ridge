...
if TYPE_CHECKING:
    ...
    from ridge.utils.rawconfig import AppConfig
...
def get_server_id():
    ...
    Helps count distinct ridge servers deployed.
    Maintains anonymity by using non-PII random id."""
    # Initialize server_id to None
    server_id = None
    # Expand path to the ridge env file. It contains persistent internal app data
    ...
    if path.exists(app_env_filename):
        ...
        # Create ridge config directory if it doesn't exist
...
command_descriptions = {
    ConversationCommand.General: "Only talk about information that relies on Ridge's general knowledge, not your personal knowledge base.",
    ...
    ConversationCommand.Help: "Get help with how to use or setup Ridge from the documentation",
...
tool_descriptions_for_llm = {
    ...
    ConversationCommand.Online: "To search for the latest, up-to-date information from the internet. Note: **Questions about Ridge should always use this data source**",
    ConversationCommand.Webpage: "To use if the user has directly provided the webpage urls or you are certain of the webpage urls to read.",
    ConversationCommand.Code: "To run Python code in a Pyodide sandbox with no network access. Helpful when need to parse information, run complex calculations, create plaintext documents, and charts for user with quantitative data. Matplotlib, bs4, pandas, numpy, etc. are available.",
...
mode_descriptions_for_llm = {
    ...
    ConversationCommand.Diagram: "Use this if the user is requesting a diagram or visual representation that requires primitives like lines, rectangles, and text. Not for quantitative data.",
}
...
class ImageIntentType(Enum):
    """
    Chat message intent by Ridge for image responses.
...
def in_debug_mode():
    ...
    return is_env_var_true("RIDGE_DEBUG")
