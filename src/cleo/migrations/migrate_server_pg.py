...
search-type:
  asymmetric:
    ...
    encoder-type: null
    model-directory: /Users/si/.ridge/search/asymmetric
  image:
    encoder: sentence-transformers/clip-ViT-B-32
    encoder-type: null
    model-directory: /Users/si/.ridge/search/image
  symmetric:
    cross-encoder: cross-encoder/ms-marco-MiniLM-L-6-v2
    encoder: sentence-transformers/all-MiniLM-L6-v2
    encoder-type: null
    model-directory: ~/.ridge/search/symmetric
version: 0.14.0
...
from ridge.database.models import AiModelApi, ChatModelOptions, SearchModelConfig
    ...
    if previous_version is None or version.parse(previous_version) < version.parse(schema_version):
        ...
        if "search-type" in raw_config and raw_config["search-type"]:
            if "asymmetric" in raw_config["search-type"]:
                ...
                # Create new search model from existing Ridge YAML config
