    ...
    const saveName = async () => {
        ...
        try {
            ...
            toast({
                ...
                description: "Failed to update name. Try again or contact us at team@ridge.dev",
            });
        }
    }
                                        ...
                                        <CardContent className="grid gap-2 overflow-hidden">
                                            ...
                                            {userConfig.subscription_state === "trial" && (
                                                <>
                                                    ...
                                                    <p className="text-gray-400">You are on a 14 day trial of the Ridge <i>Futurist</i> plan</p>
                                                    <p className="text-gray-400">See <a href="https://ridge.dev/pricing">pricing</a> for details</p>
                                                </>
