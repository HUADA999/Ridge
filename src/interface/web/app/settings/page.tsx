                                ...
                                <div className="cards flex flex-wrap gap-16">
                                    <Card className="grid grid-flow-column border border-gray-300 shadow-md rounded-lg">
                                        ...
                                        <CardContent className="overflow-hidden">
                                            ...
                                            Access Ridge from your Desktop App, Obsidian plugin, and more.
                                            </p>
                                            <Table>
                                                <TableHeader>
                                                    <TableRow>
                                    ...
                                    <Card className={cardClassName}>
                                        ...
                                        <CardContent className="overflow-hidden">
                                            {userConfig.subscription_state === "trial" && (
                                                <div>
                                                    <p>You are on a 14 day trial of the Ridge <i>Futurist</i> plan</p>
                                                    <p>See <a href="https://ridge.dev/pricing">pricing</a> for details</p>
                                                </div>
                                            ) || userConfig.subscription_state === "subscribed" && (
                                                <div>
                                                    <p>You are <b>subscribed</b> to Ridge <i>Futurist</i></p>
                                                ...
                                                <div>
                                                    <p>Subscribe to the Ridge <i>Futurist</i> plan</p>
