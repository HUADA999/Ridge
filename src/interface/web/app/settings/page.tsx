...
export default function SettingsView() {
    ...
    const disconnectNumber = async () => {
        try {
            ...
            toast({
                title: "📱 Phone",
                description: "Failed to disconnect phone number. Try again or contact us at team@ridge.dev",
            });
        }
    }
                                                            ...
                                                            <TableCell className="grid grid-flow-col grid-cols-[1fr_auto] bg-secondary rounded-xl p-3 m-1">
                                                                ...
                                                                <div className="grid grid-flow-col">
                                                                    <Copy
                                                                        ...
                                                                        onClick={() => {
                                                                            toast({title: `🔑 Copied API Key: ${key.name}`, description: `Set this API key in the Ridge apps you want to connect to this Ridge account`});
                                                                    ...
                                                                    <Trash
                                                                        ...
                                                                        onClick={() => {
                                                                            toast({title: `🔑 Deleted API Key: ${key.name}`, description: `Apps using this API key will no longer connect to this Ridge account`});
                                        ...
                                        <CardContent className="grid gap-4">
                                            ...
                                            <IntlTelInput
                                                ...
                                                initOptions={{
                                                    ...
                                                    initialCountry: "af",
                                                    utilsScript: "https://assets.ridge.dev/intl-tel-input%4023.8.0_build_js_utils.js",
