        ...
        <Card className="grid grid-flow-column border border-gray-300 shadow-md rounded-lg dark:bg-muted dark:border-none border-opacity-50 lg:w-2/3">
            ...
            <CardContent className="overflow-hidden grid gap-6">
                <p className="text-md text-gray-400">
                    Access Ridge from the{" "}
                    <a href="https://docs.ridge.dev/clients/desktop" target="_blank">
                        Desktop
                    </a>
                    , <a href="https://docs.ridge.dev/clients/obsidian">Obsidian</a>,{" "}
                    <a href="https://docs.ridge.dev/clients/emacs">Emacs</a> apps and more.
                </p>
                <Table>
                    <TableBody>
                        {apiKeys.map((key) => (
                                        ...
                                        <Copy
                                            ...
                                            onClick={() => {
                                                toast({
                                                    ...
                                                    description: `Set this API key in the Ridge apps you want to connect to this Ridge account`,
                                                });
                                        ...
                                        <Trash
                                            ...
                                            onClick={() => {
                                                toast({
                                                    ...
                                                    description: `Apps using this API key will no longer connect to this Ridge account`,
                                                });
...
export default function SettingsView() {
    ...
    const disconnectNumber = async () => {
        try {
            ...
            toast({
                title: "📱 Phone",
                description:
                    "Failed to disconnect phone number. Try again or contact us at team@ridge.dev",
            });
        }
    };
    ...
    const setSubscription = async (state: string) => {
        try {
            ...
            toast({
                ...
                description:
                    state === "cancel"
                        ? "Failed to cancel subscription. Try again or contact us at team@ridge.dev"
                        : "Failed to renew subscription. Try again or contact us at team@ridge.dev",
            });
        }
    };
    ...
    const enableFreeTrial = async () => {
        ...
        try {
            ...
            toast({
                ...
                description:
                    "Failed to enable free trial. Try again or contact us at team@ridge.dev",
            });
        }
    };
    ...
    const exportChats = async () => {
        try {
            ...
            saveAs(content, "ridge-conversations.zip");
        ...
        try {
            ...
            if (source === "computer") {
                ...
                toast({
                    ...
                    description: `Your ${source} integration to Ridge has been disconnected.`,
                });
            }
        } catch (error) {
            ...
            toast({
                ...
                description: `Failed to disconnect from ${source}. Try again or contact team@ridge.dev`,
            });
        }
    };
                                            ...
                                            <Card className={cardClassName}>
                                                ...
                                                <CardContent className="overflow-hidden">
                                                    <p className="pb-4 text-gray-400">
                                                        What should Ridge refer to you as?
                                                    </p>
                                                    <Input
                                                        type="text"
                                                    ...
                                                    {(userConfig.subscription_state === "trial" && (
                                                        <>
                                                            ...
                                                            <p className="text-gray-400">
                                                                ...
                                                                day trial of the Ridge Futurist plan.
                                                                Your trial ends on{" "}
                                                                {
                                                    ...
                                                    {(userConfig.subscription_state ==
                                                        ...
                                                        (userConfig.subscription_enabled_trial_at && (
                                                            <Button
                                                                ...
                                                                onClick={() =>
                                                                    window.open(
                                                                        `${userConfig.ridge_cloud_subscription_url}?prefilled_email=${userConfig.username}`,
                                                                        "_blank",
                                                                        "noopener,noreferrer",
                                                                    )
                                                                }
                                                ...
                                                <CardContent className="grid gap-4">
                                                    ...
                                                    {!userConfig.notion_oauth_url && (
                                                        <Input
                                                            ...
                                                            value={notionToken || ""}
                                                            placeholder="Enter API Key of your Ridge integration on Notion"
                                    ...
                                    <div className="section grid gap-8">
                                        ...
                                        <div className="cards flex flex-col flex-wrap gap-8">
                                            ...
                                            <Card className={`${cardClassName} lg:w-2/3`}>
                                                ...
                                                <CardContent className="grid gap-4">
                                                    <p className="text-gray-400">
                                                        Connect your number to chat with Ridge on
                                                        WhatsApp. Learn more about the integration{" "}
                                                        <a href="https://docs.ridge.dev/clients/whatsapp">
                                                            here
                                                        </a>
                                                        .
                                                    </p>
                                                    <div>
                                                        <IntlTelInput
                                                            ...
                                                            initOptions={{
                                                                ...
                                                                initialCountry: "af",
                                                                utilsScript:
                                                                    "https://assets.ridge.dev/intl-tel-input%4023.8.0_build_js_utils.js",
