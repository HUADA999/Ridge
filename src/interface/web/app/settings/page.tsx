                                            ...
                                            {(userConfig.subscription_state === "trial" && (
                                                <>
                                                    ...
                                                    <p className="text-gray-400">
                                                        ...
                                                        of the Ridge Futurist plan. Your trial ends
                            ...
                            <div className="section grid gap-8">
                                ...
                                <div className="cards flex flex-wrap gap-8">
                                        ...
                                        <Card className="grid grid-flow-column border border-gray-300 shadow-md rounded-lg bg-gradient-to-b from-background to-gray-50 dark:to-gray-950">
                                            ...
                                            <CardContent className="overflow-hidden grid gap-6">
                                                <p className="text-md text-gray-400">
                                                    ...
                                                    <a
                                                        href="https://docs.ridge.dev/clients/Desktop"
                                                        target="_blank"
                                                    >
                                                        Desktop
                                                    </a>
                                                    ,{" "}
                                                    <a href="https://docs.ridge.dev/clients/Obsidian">
                                                        Obsidian
                                                    </a>
                                                    ,{" "}
                                                    <a href="https://docs.ridge.dev/clients/Emacs">
                                                        Emacs
                                                    </a>{" "}
                                                    apps and more.
                                                </p>
                                    ...
                                    <Card className={cardClassName}>
                                        ...
                                        <CardContent className="grid gap-4">
                                            <p className="text-gray-400">
                                                Connect your number to chat with Ridge on WhatsApp.
