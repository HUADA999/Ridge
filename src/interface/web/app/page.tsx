...
function ChatBodyData(props: ChatBodyDataProps) {
    ...
    const [selectedAgent, setSelectedAgent] = useState<string | null>("ridge");
    ...
    useEffect(() => {
        ...
        setSelectedAgent(agents.length > 1 ? agents[0].slug : "ridge");
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger>
                                <Button className="w-full m-2 p-0" variant="outline">
                                    ...
                                    {selectedAgent
                                        ? `${agents?.find((agent) => agent.slug === selectedAgent)?.name ?? "Ridge"}`
                                        : "Select Agent"}
                                </Button>
                            </DropdownMenuTrigger>
                            <DropdownMenuContent align="end" className="overflow-y-scroll max-h-96">
                                {agentIcons.length > 0 ? (
                                    ...
                                    <DropdownMenuItem
                                        key="0-ridge"
                                        onClick={() => {
                                            setSelectedAgent("ridge");
                                            chatInputRef.current?.focus();
                                        }}
                                    >
                                        {getIconFromIconName("Lightbulb", "orange")} Ridge
                                    </DropdownMenuItem>
                                )}
                            </DropdownMenuContent>
                        </DropdownMenu>
        ...
        <SidebarProvider>
            ...
            <SidebarInset>
                ...
                <div className={`${styles.main} ${styles.chatLayout}`}>
                    <title>Ridge AI - Your Second Brain</title>
