...
export default function LoginPrompt(props: LoginPromptProps) {
    return (
        <AlertDialog
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>Sign in to Ridge to continue</AlertDialogTitle>
                </AlertDialogHeader>
                <AlertDialogDescription>{props.loginRedirectMessage}. By logging in, you agree to our <Link href="https://ridge.dev/terms-of-service">Terms of Service.</Link></AlertDialogDescription>
                <AlertDialogFooter>
