    ...
    return (
        <Dialog open={true} onOpenChange={props.onOpenChange}>
            ...
            >
                <div>
                    {/* <DialogHeader>
                        <DialogTitle>Sign in to Ridge to continue</DialogTitle>
                    </DialogHeader>
        ...
        <div>
            ...
            <div className="flex flex-col gap-4 text-center p-4">
                <div className="text-center font-bold text-lg">
                    Sign In for free to start using Ridge: Your AI-powered second brain
                </div>
            </div>
            ...
            <div className="text-center text-muted-foreground text-xs">
                ...
                <Link href="https://ridge.dev/terms-of-service">Terms of Service.</Link>
            </div>
        </div>
    );
}
