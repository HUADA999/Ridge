...
function EmailSignInContext({
    ...
    return (
        <div className="flex flex-col gap-4 p-4">
            ...
            <div>
                <div className="text-center font-bold text-xl">Get started with Ridge</div>
            </div>
...
function MainSignInContext({
    ...
    const tips = [
        {
            src: "https://assets.ridge.dev/sign_in_demos/research_mode.gif",
            alt: "Research tip",
            description: "Use research mode to find answers to your questions",
        },
        {
            src: "https://assets.ridge.dev/sign_in_demos/custom_agents.gif",
            alt: "Personalize tip",
            description: "Personalize your Ridge experience by creating custom agents",
        },
        {
            src: "https://assets.ridge.dev/sign_in_demos/docment_questions.gif",
            alt: "Document tip",
    ...
    return (
        <div className="flex flex-col gap-4 p-4 md:p-0">
            ...
            <div className="text-center text-muted-foreground text-sm mb-[20px]">
                ...
                <Link href="https://ridge.dev/terms-of-service">Terms of Service</Link>. See{" "}
                <Link href="https://ridge.dev/privacy-policy">Privacy Policy</Link>.
            </div>
        </div>
    );
}
