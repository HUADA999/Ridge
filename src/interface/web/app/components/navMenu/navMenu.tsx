                    ...
                    <DropdownMenuContent className="gap-2">
                        <DropdownMenuItem className="w-full">
                            <div className="flex flex-col">
                                ...
                                {userData?.ridge_version && (
                                    <VersionBadge version={userData?.ridge_version} />
                                )}
                            </div>
                        </DropdownMenuItem>
                        <DropdownMenuSeparator />
                        ...
                        <>
                            <DropdownMenuSeparator />
                            <DropdownMenuItem>
                                <Link href="https://docs.ridge.dev" className="no-underline w-full">
                                    <div className="flex flex-rows">
                            ...
                            <DropdownMenuItem>
                                <Link
                                    href="https://github.com/ridge-ai/ridge/releases"
