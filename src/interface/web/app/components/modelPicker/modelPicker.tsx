        ...
        <div className={styles.modelPicker}>
            ...
            <AlertDialog open={openLoginDialog} onOpenChange={setOpenLoginDialog}>
                <AlertDialogContent>
                    ...
                    <AlertDialogDescription>Once you create an account with Ridge, you can configure your model and use a whole suite of other features. Check out our <a href="https://docs.ridge.dev/">documentation</a> to learn more.
                    </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
