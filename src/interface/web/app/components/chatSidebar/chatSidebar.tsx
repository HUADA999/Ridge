...
function ChatSidebarInternal({ ...props }: ChatSideBarProps) {
    const isEditable = props.preexistingAgent?.name.toLowerCase() === "ridge" || props.preexistingAgent?.is_hidden === true;
    const isDefaultAgent = props.preexistingAgent?.name.toLowerCase() === "ridge";
