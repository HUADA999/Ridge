...
function AgentCard(props: AgentCardProps) {
    ...
    if (showModal) {
        window.history.pushState({}, `Ridge AI - Agent ${props.data.slug}`, `/agents?agent=${props.data.slug}`);
    }
                        ...
                        !props.isMobileWidth ?
                            <Dialog
                                ...
                                onOpenChange={() => {
                                    ...
                                    window.history.pushState({}, `Ridge AI - Agents`, `/agents`);
                                }}>
                                <DialogTrigger>
                            ...
                            <AlertDialog>
                                ...
                                <AlertDialogContent>
                                    <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription>
                                            Custom Agents will be coming to Ridge soon!
                                        </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
