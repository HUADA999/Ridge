...
export default function Chat() {
    const defaultTitle = "Ridge AI - Chat";
    ...
    async function chat() {
        ...
        try {
            ...
            if (errorMessage.includes("Error in input stream"))
                ...
                currentMessage.rawResponse = `Umm, not sure what just happened but I lost my train of thought. Could you try again or ask my developers to look into this if the issue persists? They can be contacted at the Ridge Github, Discord or team@ridge.dev.`;
