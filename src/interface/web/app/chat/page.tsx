            ...
            <div className={styles.chatBox}>
                ...
                <div className={styles.chatBoxBody}>
                    ...
                    {/* <div className={styles.agentIndicator}>
                        <a className='no-underline' href="/agents?agent=ridge" target="_blank" rel="noreferrer">
                            <Lightbulb color='var(--ridge-orange)' weight='fill' />
                            <span className='text-neutral-600'>Ridge</span>
                        </a>
                    </div> */}
