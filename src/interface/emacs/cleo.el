;;; ridge.el --- A search assistant for your second brain -*- lexical-binding: t -*-
...
(transient-define-argument ridge--content-type-switch ()
  ...
  :choices (or (ignore-errors (mapcar #'symbol-name (ridge--get-enabled-content-types))) '("org" "markdown" "pdf" "ledger" "music" "image")))
