...
window.needsSubscriptionAPI.onNeedsSubscription((event, needsSubscription) => {
    ...
    if (needsSubscription) {
        window.alert("Looks like you're out of space to sync your files. Upgrade your plan to unlock more space here: https://app.ridge.dev/settings#subscription");
        needsSubscriptionElement.style.display = 'block';
    }
});

const urlInput = document.getElementById('ridge-host-url');
(async function () {
