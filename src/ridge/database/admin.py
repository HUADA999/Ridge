...
class RidgeDjangoJobAdmin(DjangoJobAdmin, unfold_admin.ModelAdmin):
    list_display = (
        "id",
        "next_run_time",
        "job_info",
...
class RidgeDjangoJobExecutionAdmin(DjangoJobExecutionAdmin, unfold_admin.ModelAdmin):
    pass


admin.site.unregister(DjangoJob)
admin.site.register(DjangoJob, RidgeDjangoJobAdmin)
admin.site.unregister(DjangoJobExecution)
admin.site.register(DjangoJobExecution, RidgeDjangoJobExecutionAdmin)
...
class RidgeUserAdmin(UserAdmin, unfold_admin.ModelAdmin):
...
class RidgeUserSubscription(unfold_admin.ModelAdmin):
    list_display = (
        "id",
        "user",
        "type",
    ...
    def export_selected_objects(self, request, queryset):
        ...
        for conversation in queryset:
            ...
            for idx, log in enumerate(chat_log):
                if log["by"] == "ridge" and log["images"]:
