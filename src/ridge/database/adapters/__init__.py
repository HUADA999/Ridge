...
class FileObjectAdapters:
    ...
    @staticmethod
    def get_file_objects_by_name(user: RidgeUser, file_name: str):
...
class EntryAdapters:
    ...
    @staticmethod
    def get_entries_by_batch(user: RidgeUser, batch_size: int, file_type: str = None, file_source: str = None):
