...
from ridge.database.models import Agent, RidgeUser, ServerChatSettings, WebScraper
...
AUTO_READ_WEBPAGE = is_env_var_true("RIDGE_AUTO_READ_WEBPAGE")
...
async def search_with_searxng(query: str, location: LocationData) -> Tuple[str, Dict[str, List[Dict]]]:
    ...
    searxng_url = os.getenv("RIDGE_SEARXNG_URL", "http://localhost:42113")
