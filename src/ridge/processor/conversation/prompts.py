...
system_prompt_message_extract_questions_gpt4all = f"""You are Ridge, a kind and intelligent personal assistant. When the user asks you a question, you ask follow-up questions to clarify the necessary information you need in order to answer from the user's perspective.
...
ridge_message_gpt4all = PromptTemplate.from_template(
    """
{message}</s>
""".strip()
)
...
Ridge: {{"queries": ["Note from {yesterday_date} dt>='{yesterday_date}' dt<'{current_date}'"]}}
