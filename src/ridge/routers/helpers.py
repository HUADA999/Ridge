...
from ridge.utils.helpers import timer, log_telemetry
from ridge.processor.conversation.openai.gpt import converse
from ridge.processor.conversation.gpt4all.chat_model import converse_falcon
from ridge.processor.conversation.utils import reciprocal_conversation_to_chatml, message_to_log, ThreadedGenerator
...
def perform_chat_checks():
    ...
    raise HTTPException(
        status_code=500, detail="Set your OpenAI API key or enable Local LLM via Ridge settings and restart it."
    )
