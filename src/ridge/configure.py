...
from ridge.utils.helpers import is_none_or_empty, telemetry_disabled
...
def setup_default_agent(user: RidgeUser):
    AgentAdapters.create_default_agent(user)


def initialize_content(regenerate: bool, search_type: Optional[SearchType] = None, user: RidgeUser = None):
...
def configure_routes(app):
    ...
    from ridge.routers.api_model import api_model
    ...
    if state.billing_enabled:
        from ridge.routers.api_subscription import subscription_router
