;;; ridge-tests.el --- Test suite for ridge.el  -*- lexical-binding: t -*-
...
;; URL: https://github.com/debanjum/ridge/tree/master/src/ridge/interface/emacs
...
;; This file contains the test suite for ridge.el.
...
(ert-deftest ridge-tests--extract-entries-as-markdown ()
  "Test `json-response', `query' from API formatted as markdown."
  (let ((user-query "Become God")
        (json-response-from-ridge-backend
...
(ert-deftest ridge-tests--extract-entries-as-org ()
...
(ert-deftest ridge-tests--extract-entries-as-ledger ()
...
")))
    (should
     (equal
      (ridge--extract-entries-as-ledger json-response-from-ridge-backend user-query)
      ";; Become God\n\
\n\
...
(ert-deftest ridge-tests--get-current-outline-entry-text ()
...
(ert-deftest ridge-tests--get-current-paragraph-text ()
