...
* Ridge
  ...
  User can interface with Ridge via the API or [[./src/interface/emacs/ridge.el][Emacs]]. All search is done locally[[https://github.com/debanjum/ridge#miscellaneous][*]]
