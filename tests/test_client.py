...
def test_get_api_config_types(client, search_config: SearchConfig, sample_org_data, default_user2: RidgeUser):
    # Arrange
...
# ----------------------------------------------------------------------------------------------------
@pytest.mark.django_db(transaction=True)
def test_notes_search(client, search_config: SearchConfig, sample_org_data, default_user2: RidgeUser):
    # Arrange
    text_search.setup(OrgToJsonl, sample_org_data, regenerate=False, user=default_user2)
    ...
    assert "git clone https://github.com/ridge-ai/ridge" in search_result


# ----------------------------------------------------------------------------------------------------
@pytest.mark.django_db(transaction=True)
def test_notes_search_with_only_filters(
    client, content_config: ContentConfig, search_config: SearchConfig, sample_org_data, default_user2: RidgeUser
):
    # Arrange
    text_search.setup(
        OrgToJsonl,
...
# ----------------------------------------------------------------------------------------------------
@pytest.mark.django_db(transaction=True)
def test_notes_search_with_include_filter(client, sample_org_data, default_user2: RidgeUser):
    # Arrange
    text_search.setup(OrgToJsonl, sample_org_data, regenerate=False, user=default_user2)
...
# ----------------------------------------------------------------------------------------------------
@pytest.mark.django_db(transaction=True)
def test_notes_search_with_exclude_filter(client, sample_org_data, default_user2: RidgeUser):
    # Arrange
    text_search.setup(
        OrgToJsonl,
        sample_org_data,
