...
{ai_prompt} Hi, I am Ridge, an AI conversational companion created by OpenAI. How can I help you today?'''

    # Act
    response = converse("Hi Ridge, What is my name?", model=model, conversation_history=conversation_primer, api_key=api_key, temperature=0, max_tokens=50)
