...
from ridge.database.models import Agent, ChatModel, Entry, RidgeUser
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.chatquality
def test_summarize_one_file(client_offline_chat, default_user2: RidgeUser):
    # Arrange
    message_list = []
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.chatquality
def test_summarize_extra_text(client_offline_chat, default_user2: RidgeUser):
    # Arrange
    message_list = []
    conversation = create_conversation(message_list, default_user2)
    # post "Xi Li.markdown" file to the file filters
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.chatquality
def test_summarize_multiple_files(client_offline_chat, default_user2: RidgeUser):
    # Arrange
    message_list = []
    conversation = create_conversation(message_list, default_user2)
    # post "Xi Li.markdown" file to the file filters
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.chatquality
def test_summarize_no_files(client_offline_chat, default_user2: RidgeUser):
    # Arrange
    message_list = []
    conversation = create_conversation(message_list, default_user2)
    # Act
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.chatquality
def test_summarize_different_conversation(client_offline_chat, default_user2: RidgeUser):
    message_list = []
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.chatquality
def test_summarize_nonexistant_file(client_offline_chat, default_user2: RidgeUser):
    # Arrange
    message_list = []
    conversation = create_conversation(message_list, default_user2)
...
def test_summarize_diff_user_file(
    client_offline_chat, default_user: RidgeUser, pdf_configured_user1, default_user2: RidgeUser
):
    # Arrange
    message_list = []
    conversation = create_conversation(message_list, default_user2)
...
@pytest.mark.chatquality
@pytest.mark.django_db(transaction=True)
def test_answer_in_chat_history_beyond_lookback_window(client_offline_chat, default_user2: RidgeUser):
    # Arrange
    message_list = [
        ("Hello, my name is Testatron. Who are you?", "Hi, I am Ridge, a personal assistant. How can I help?", []),
        ("When was I born?", "You were born on 1st April 1984.", []),
...
@pytest.mark.chatquality
@pytest.mark.django_db(transaction=True)
def test_answer_in_chat_history_by_conversation_id(client_offline_chat, default_user2: RidgeUser):
    # Arrange
    message_list = [
        ("Hello, my name is Testatron. Who are you?", "Hi, I am Ridge, a personal assistant. How can I help?", []),
        ("When was I born?", "You were born on 1st April 1984.", []),
...
def test_answer_in_chat_history_by_conversation_id_with_agent(
    client_offline_chat, default_user2: RidgeUser, offline_agent: Agent
):
    # Arrange
    message_list = [
        ("Hello, my name is Testatron. Who are you?", "Hi, I am Ridge, a personal assistant. How can I help?", []),
