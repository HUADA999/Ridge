...
# Internal Packages
from ridge.processor.conversation.gpt4all.chat_model import converse_offline, extract_questions_offline, filter_questions
...
def test_chat_with_no_chat_history_or_retrieved_content(loaded_model):
    ...
    # Assert
    expected_responses = ["Ridge", "ridge", "khooj", "Khooj", "RIDGE"]
