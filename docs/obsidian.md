<h1><img src="./assets/ridge-logo-sideways-500.png" width="200" alt="Ridge Logo"> Obsidian</h1>
...
See [Ridge Search](/search) for more details. Use [query filters](/advanced#query-filters) to limit entries to search
