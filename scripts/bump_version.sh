...
do
    case "${opt}" in
        t)
            ...
            cd ../emacs
            sed -E -i.bak "s/^;; Version: (.*)/;; Version: $current_version/" ridge.el
            git add ridge.el
            rm *.bak
            ...
            git add \
                ...
                $project_root/src/interface/emacs/ridge.el \
                $project_root/manifest.json \
                $project_root/versions.json
            git commit -m "Release Ridge version $current_version"
        ...
        n)
            ...
            sed -E -i.bak "s/^;; Version: (.*)/;; Version: $next_version/" ridge.el
            rm *.bak
            ...
            git add \
                ...
                $project_root/src/interface/obsidian/versions.json \
                $project_root/src/interface/emacs/ridge.el
            git commit -m "Bump Ridge to pre-release version $next_version"
            ;;
        ?)
